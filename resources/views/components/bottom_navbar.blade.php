...
<div class="btm-nav bg-opacity-80 backdrop-blur">
    ...
    <button class="{{request()->routeIs('posts.edit', 1) ? 'active bg-neutral bg-opacity-60' : ''}} hover:bg-base-300 hover:bg-opacity-50" onclick="window.location='{{route('posts.edit', 1)}}'">
